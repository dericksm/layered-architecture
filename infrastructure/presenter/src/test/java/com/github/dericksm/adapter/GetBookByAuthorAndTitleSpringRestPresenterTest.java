...
class GetBookByAuthorAndTitleSpringRestPresenterTest {
    ...
    @InjectMocks
    private GetBookByAuthorAndTitleSpringRestPresenter getBookByAuthorAndTitleSpringRestPresenter;

    @Test
    void present_shouldSerializeResponse() throws IOException {
        var bookResponseMock = new BookResponse();
        getBookByAuthorAndTitleSpringRestPresenter.present(bookResponseMock);
